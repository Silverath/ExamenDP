...
<%-- 	</security:authorize> --%>
	...
	<jstl:choose>
		...
		<jstl:choose>
			...
			<spring:message code="trip.warningNote.create" var="createWarningNoteHeader" />	
		<display:column title="${createWarningNoteHeader}">
			<a href="warningNote/manager/create.do?tripId=${row.id}"> 
				<spring:message code="trip.warningNote.create"/>
			</a>
		</display:column>
	</security:authorize>
	...
	<spring:message code="trip.warningNotes" var="warningNoteHeader" />	
		<display:column title="${warningNoteHeader}">
		<a href="warningNote/list.do?tripId=${row.id}"> 
			<spring:message code="trip.warningNotes"/>
		</a>
		</display:column>
